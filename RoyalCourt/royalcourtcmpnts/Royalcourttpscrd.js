...
const Royalcourttpscrd = ({ adv }) => {
  ...
  const addToFavorites = () => {
    if (adv.favorite) setToggleMenu(false);
      ...
      saveRoyalCourtAdvice(updatedAdvices, adv);
      setToggleMenu(false);
    }
  };
            ...
            <View style={{ alignItems: 'center' }}>
              <View>
                ...
                <View style={{ width: 200 }}>
                  <Text
                    style={styles.royalcourtcorransttl}
                    ellipsizeMode="tail"
                  >
                    {adv.royalcourtadv}
                  </Text>
...
export default Royalcourttpscrd;
